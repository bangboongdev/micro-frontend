    ...
    <a-col :span="20">
      <a-row>
        <a-col :span="18">
                ...
                <a-col :span="24">
                  ...
                  <a-row :gutter="[0, 24]">
                    <a-col :span="24">
                      <a-row>
                        <a-col :span="6">
                          <p>{{ fields.question_type_id.label }}</p>
                        </a-col>
                        <a-col :span="1">:</a-col>
                        <a-col :span="17">
                          <p>{{form.name_of_question_type_id}}</p>
                        </a-col>
                      </a-row>
                    </a-col>
                  </a-row>
          ...
          <a-row>
            <a-card hoverable :bordered="false" class="card-border" title="Thông tin hệ thống" style="width: 100%">
              <a-row type="flex" justify="start" align="middle">
                <a-col :span="24">
                  <a-row :gutter="[0, 24]">
                    <a-col :span="24">
