      ...
      <a-row type="flex" :gutter="[24, 0]">
        <a-col :span="18">
          <a-card
            ...
            :bordered="false"
            class="card-border"
            :title="$t('customer.title.general_information')"
          >
            <a-row :gutter="[0, 24]">
              <a-col :span="24">
                <a-row>
              ...
              <a-col :span="24" v-if="form.type == '1'">
                <a-row>
                  <a-col :span="4">
                    <span>{{ fields.tax_code.label }}</span>
                  </a-col>
                  <a-col :span="1">:</a-col>
                  <a-col :span="10"> {{ form.tax_code }}</a-col>
                </a-row>
              </a-col>
              ...
              <a-col :span="24">
                <a-row>
                  ...
                  <a-col :span="1">:</a-col>
                  <a-col :span="10">
                    <span v-if="form.type == '1'">Cá nhân</span>
                    <span v-else-if="form.type == '2'">Tổ chức</span>
                  </a-col>
                </a-row>
              </a-col>
              ...
              <a-col :span="24">
                <a-row>
                  <a-col :span="4">
                    <span>{{
                      form.type == 2 ? "Tên tổ chức" : fields.name.label
                    }}</span>
                  </a-col>
                  <a-col :span="1">:</a-col>
              ...
              <a-col :span="24" v-if="form.type == '2'">
                <a-row>
                  <a-col :span="4">
                    <span>{{ fields.delegate.label }}</span>
                  </a-col>
                  <a-col :span="1">:</a-col>
                  <a-col :span="10">{{ form.delegate }}</a-col>
                </a-row>
              </a-col>
              ...
              <a-col :span="24" v-if="form.type == '1'">
                <a-row>
                  <a-col :span="4">
                    <span>{{ fields.identify_no.label }}</span>
                  </a-col>
                  <a-col :span="1">:</a-col>
                  <a-col :span="10">{{ form.identify_no }}</a-col>
                </a-row>
              </a-col>
                <a-col :span="24" v-if="form.type == '1'">
                <a-row>
                  <a-col :span="4">
                    <span>{{ fields.identify_type.label }}</span>
                  </a-col>
                  <a-col :span="1">:</a-col>
                  <a-col :span="10">{{ form.identify_type }}</a-col>
                </a-row>
              </a-col>
              ...
              <a-col :span="24" v-if="form.type == '1'">
                <a-row>
                  <a-col :span="4">
                    <span>{{ fields.sex.label }}</span>
                  </a-col>
                  <a-col :span="1">:</a-col>
                  <a-col :span="10">
                    <span v-if="form.sex == '2'">Nữ</span>
                    <span v-else-if="form.sex == '1'">Nam</span>
                    <span v-else-if="form.sex == '3'">Giới tính khác</span>
                  </a-col>
                </a-row>
              </a-col>
              ...
              <a-col :span="24" v-if="form.type == '1'">
                <a-row>
                  <a-col :span="4">
                    <span>{{ fields.birth_date.label }}</span>
                  </a-col>
                  <a-col :span="1">:</a-col>
                  <a-col :span="10">
                    <span>
                      {{
                        form.birth_date
                          ? moment(form.birth_date).format("DD/MM/YYYY")
                          : "--"
                      }}
                    </span>
                  </a-col>
          ...
          <a-card
            ...
            :bordered="false"
            class="card-border"
            :title="$t('customer.title.contact_info')"
          >
            <a-row :gutter="[0, 24]">
              <a-col :span="24">
                <a-row>
                  <a-col :span="4">
                    <span>{{ fields.mobile_no.label }}</span>
                  </a-col>
                  <a-col :span="1">:</a-col>
                  <a-col :span="10">
                    <a :href="'tel:' + text">{{ form.mobile_no }}</a>
                  </a-col>
                </a-row>
              </a-col>
              ...
              <a-col :span="24">
                <a-row>
                  <a-col :span="4">
                    <span>{{ fields.name_of_province_id.label }}</span>
                  </a-col>
                  <a-col :span="1">:</a-col>
                  <a-col :span="10">{{ form.name_of_province_id }}</a-col>
                </a-row>
              </a-col>
              ...
              <a-col :span="24">
                <a-row>
                  <a-col :span="4">
                    <span>{{ fields.name_of_district_id.label }}</span>
                  </a-col>
                  <a-col :span="1">:</a-col>
                  <a-col :span="10">{{ form.name_of_district_id }}</a-col>
                </a-row>
              </a-col>
              ...
              <a-col :span="24">
                <a-row>
                  <a-col :span="4">
                    <span>{{ fields.address.label }}</span>
                  </a-col>
                  <a-col :span="1">:</a-col>
                  <a-col :span="10">{{ form.address }}</a-col>
                </a-row>
              </a-col>
            </a-row>
          </a-card>
          ...
          <a-card
            ...
            :bordered="false"
            class="card-border"
            :title="$t('customer.title.system_information')"
          >
            <a-row :gutter="[0, 24]">
              <a-col :span="24">
                <a-row>
        ...
        <a-col :span="6">
          <a-card
            ...
            :bordered="false"
            class="card-border"
            :title="$t('customer.attribute.avatar_id')"
          >
            <a-row justify="center">
              <img
          ...
          <a-card
            ...
            :bordered="false"
            class="card-border"
            :title="$t('customer.attribute.is_active')"
          >
